...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        self.new_note_url = reverse_lazy('note_new')

    def test_note_list_user_not_logged_in(self):
        response = self.client.get(self.list_url)

        self.assertEquals(response.status_code, 302)

    def test_note_list_user_logged_in(self):
    ...
    def test_add_new_note_user_logged_in(self):
        self.client.login(username = self.test_user_2.username , password = '2pass@123')
        response = self.client.post(self.new_note_url, {
            'title': 'test note 2',
            'body': 'slim2',
    ...
    def test_delete_note_user_not_logged_in(self):
        pass